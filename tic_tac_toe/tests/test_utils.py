...
class TestUtils(unittest.TestCase):
    ...
    def test_check_winner_draw(self):
        board = np.array([[1, -1, 1],
                          ...
                          [-1, 1, -1]])
        winner = utils.check_winner(board)
        expected_winner = utils.PlayerSymbol.EMPTY
    ...
    def test_check_winner_player_x_horizontal(self):
        board = np.array([[1, 1, 1],
                          ...
                          [0, 0, 0]])
        winner = utils.check_winner(board)
        expected_winner = utils.PlayerSymbol.X
        self.assertEqual(winner, expected_winner)
    ...
    def test_check_winner_player_y_horizontal(self):
        board = np.array([[1, 0, 1],
                          ...
                          [0, 0, 0]])
        winner = utils.check_winner(board)
        expected_winner = utils.PlayerSymbol.Y
        self.assertEqual(winner, expected_winner)
    ...
    def test_get_winner_name_x(self):
        winner = utils.get_winner_name(utils.PlayerSymbol.X)
        expected_name = "X"
        self.assertEqual(winner, expected_name)

    def test_get_winner_name_y(self):
        winner = utils.get_winner_name(utils.PlayerSymbol.Y)
        expected_name = "O"
        self.assertEqual(winner, expected_name)

    def test_get_winner_name_draw(self):
        winner = utils.get_winner_name(utils.PlayerSymbol.EMPTY)
        expected_name = "Draw"
        self.assertEqual(winner, expected_name)

    def test_available_positions_empty(self):
        board = np.zeros((3, 3), dtype=int)
        available_positions = utils.get_available_positions(board)
    ...
    def test_is_valid_empty_board(self):
        board = np.zeros((3, 3), dtype=int)
        valid = utils.is_valid_board(board)
        expected = True
    ...
    def test_generate_all_states(self):
        all_states = utils.generate_all_states()
